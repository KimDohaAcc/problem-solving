...
class Solution {
    ...
    public int[] solution(int n, int[][] paths, int[] gates, int[] summits) {
        ...
        Arrays.sort(summits);
        for(int i = 0; i < summits.length; i ++) {
            dijkstra(summits[i], nodeList, gateList, summitList, n);
        }
    ...
    static void dijkstra(int s, List<int[]>[] nodeList, List<Integer> gateList, List<Integer> summitList, int n) {
